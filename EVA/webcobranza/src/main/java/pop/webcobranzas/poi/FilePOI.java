 ...
 * @author PR154357
 */
public class FilePOI  extends Comunes{
    
    
    public static void main(String...args)throws Exception{
         XWPFDocument document = new FilePOI().generateWordXWPFDocument();
      FileOutputStream out = new FileOutputStream(new File
         ("C:\\Users\\PR154357\\Documents\\urgente.docx"));
    ...
    String otrosidigo1="PRIMER OTROSÍ DIGO:";
    ...
    String otrosidigo2="SEGUNDO OTROSÍ DIGO:";
    ...
    String otrosidigo3="TERCER OTROSÍ DIGO:";
    String otrosidigo4="CUARTO OTROSÍ DIGO:";
    ...
    String otrosidigo5="QUINTO OTROSÍ DIGO:";
    ...
    //String[] anexo4={"4.   Copia Legalizada del Acta de Junta de fecha "+FECHA_ACTA+".", " (ANEXO 1-D)."};
    ...
    public XWPFDocument generateWordXWPFDocument() {
        ...
        String FONDO_DESCRIPCION="FONDO POPULAR 1 - RENTA MIXTA, FONDO DE INVERSION PRIVADO";
        String FONDO_RUC="";
        String DATAINVERSION="S/. 17,329.70 (DIECISIETE MIL TRESCIENTOS VEINTINUEVE CON 70/100 SOLES)";
        String DATAMESES="";
        String DATACUOTASMENSUALES="";
        String DATADIRECCION="JIRÓN PARQUE ALTO MANZANA A LOTE 5, ASENTAMIENTO HUMANO PARQUE ALTO, DISTRITO DE SANTIAGO DE SURCO, PROVINCIA DE LIMA, DEPARTAMENTO DE LIMA";
        String DATANOMBRESAPELLIDOS="NELLY NAZARIA RUIZ VASQUEZ DE VASQUEZ, identificado(a) con DNI N° 08759158 y VICTOR JOSE VASQUEZ LEYVA, identificado(a) con DNI N° 08759189";
        String DATAFEMISIONYVENCIMIENTO="";
        String DATANCUOTA="48";
        String F_ESCRITURA="";
        String F_DE_FECHA="";
        String F_EMITIDO="";
        String FTCHN="";
        String STCHN="";        
        String ASIENTO1="D0005";
        String ASIENTO2="D0006";
        String PARTIDA="46139267";
        String F_CN="";
        String PAGO="";
        String FECHA_CORTE="";//28/08/2019
        String VALOR_DOLARES="US$ 88763.00";
        String FECHA_ACTA="07/09/2011";
        String FECHA_DEMANDA="";
        String MONTO_A_DEMANDAR="S/. 12,546,364.76";
        String TCHN="";
        String FONDO_PIE="";
